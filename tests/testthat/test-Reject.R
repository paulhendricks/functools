...
test_that("Produces the correct output.", {
  expect_equal(Reject(foo, less_than_5), base::Filter(base::Negate(less_than_5), foo))
  expect_equal(Reject(letters, more_than_m), base::Filter(base::Negate(more_than_m), letters))
})
